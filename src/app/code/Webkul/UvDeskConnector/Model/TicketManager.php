...
class TicketManager
{
     ...
     * @return json.
     */
    public function getAllTicketss($page=null, $labels=null, $tab=null, $agent=null, $customer=null, $group=null, $team=null, $priority=null, $type=null, $tag=null, $mailbox=null, $status=null, $sort=null)
    {
        $access_token = $this->_helperData->getAccessToken();
        $company_domain = $this->_helperData->getCompanyDomainName();
        $str = '';
